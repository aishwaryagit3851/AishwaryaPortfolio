...
function About() {
  return (
    <div className="flex flex-col justify center mb-32">
      <div className="p-2 sm:p-12 grid grid-row-2 grid-cols-1 sm:grid-cols-4 justify-center mx-10 sm:mx-20 gap-3 md:gap-0">
        <div className="sm:col-span-3 justify-center px-2 sm:px-5">
          <p className="text-2xl sm:text-4xl font-bold py-3 heading">
            About me ...
          </p>
          <p className="text-xs sm:text-lg font-base">
